...
export default function StatementsTab({
  ...
  const [activeView, setActiveView] = useState("approved"); // "approved" or "request"
      ...
      <article className="panel wide">
        <div style={{ display: "flex", gap: "10px", marginBottom: "20px", alignItems: "center" }}>
          <button
            ...
            style={{
              padding: "10px 20px",
              backgroundColor: activeView === "approved" ? "#0f6bcf" : "#e0e0e0",
              color: activeView === "approved" ? "white" : "black",
              border: "none",
              borderRadius: "4px",
              cursor: "pointer",
              fontWeight: "bold",
          ...
          <button
            ...
            style={{
              padding: "10px 20px",
              backgroundColor: activeView === "request" ? "#0f6bcf" : "#e0e0e0",
              color: activeView === "request" ? "white" : "black",
              border: "none",
              borderRadius: "4px",
              cursor: "pointer",
              fontWeight: "bold",
          ...
          <button
            ...
            style={{
              padding: "10px 20px",
              backgroundColor: activeView === "requests" ? "#0f6bcf" : "#e0e0e0",
              color: activeView === "requests" ? "white" : "black",
              border: "none",
              borderRadius: "4px",
              cursor: "pointer",
              fontWeight: "bold",
          ...
          <button
            ...
            style={{
              padding: "10px 20px",
              backgroundColor: activeView === "sms" ? "#0f6bcf" : "#e0e0e0",
              color: activeView === "sms" ? "white" : "black",
              border: "none",
              borderRadius: "4px",
              cursor: "pointer",
              fontWeight: "bold",
